...
public abstract class Page extends TestRoot{
	...
	public static void popupOk(AndroidDriver<MobileElement> d){
		waitToClick(d, find(elements.Page.alertConfirmId), 5);
	}
	public static void popupCancel(AndroidDriver<MobileElement> d){
		waitToClick(d, find(elements.Page.alertCancelId), 5);
	}
